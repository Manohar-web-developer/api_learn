...
const materialtModel = require("../../modules/admin/material");
...
exports.create = async (request, response) => {
    ...
    dataSave.slug = await generateUniqueSlug(materialtModel, slug)
    materialtModel(dataSave).save()
        .then((result) => {
            const data = {
                _status: true,
...
exports.view = async (request, response) => {
    ...
    try {
        const totalRecord = await materialtModel.find(filterData).countDocuments();
        materialtModel.find(filterData)
            .limit(limit)
            .skip(skip)
            .then((result) => {
                const data = {
...
exports.details = async (request, response) => {
    ...
    try {
        ...
        const result = await materialtModel.findOne({
            _id: id,
            delete_at: null
        })
...
exports.update = async (request, response) => {
    try {
        ...
        const result = await materialtModel.findOneAndUpdate({
            _id: id,
            delete_at: null
        }, {
            $set: updateData
...
exports.changeStatus = async (request, response) => {
    try {
        ...
        const data = await materialtModel.findOne({
            _id: id,
            delete_at: null
        });
